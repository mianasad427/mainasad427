	...
	return (
		<>
			<SEO
				...
				description="Learn about Muhammad Asadullah, a passionate software developer specializing in full stack web development, database systems, and cloud computing."
				canonicalUrl="https://portfolio.com/about"
			/>
					...
					<ScrollAnimation className="space-y-6">
						<div className="space-y-4">
							<p className="text-gray-300 leading-relaxed">
								Hi! I'm Muhammad Asadullah, a passionate software developer with expertise in building modern web applications. My journey in tech started during my university years, where I discovered my love for creating innovative solutions through code.
							</p>
							<p className="text-gray-300 leading-relaxed">
								I completed my Bachelor's degree in Software Engineering with a CGPA of 3.14 out of 4.00, maintaining strong academic performance while actively engaging in real-world projects. I also hold a strong academic record from my Matriculation and Intermediate studies.
							</p>
							<p className="text-gray-300 leading-relaxed">
						...
						<ScrollAnimation>
							<div className="pt-4">
								...
								<ul className="list-none space-y-3">
									{["Father Name: Abdul Islam", "Bachelor (Software Engineering) - 3.14/4.00 CGPA", "Passionate about Software Development"].map((fact, index) => (
										<motion.li
											key={fact}
